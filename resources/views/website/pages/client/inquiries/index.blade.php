...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('client.inquiries.create') }}" class="btn btn-primary btn-sm">
                    ...
                    @forelse($inquiries as $inq)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('client.inquiries.delete', $inq->id) }}" class="d-inline">
                                    @csrf @method('DELETE')
                                    <button class="btn btn-outline-danger btn-sm mb-1" onclick="return confirm('Delete this inquiry?')">
