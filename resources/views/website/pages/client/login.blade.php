...
@endif
                    <div class="mb-3">
                        ...
                        <input type="text" name="email" id="email" class="form-control form-control-lg" placeholder="Enter your email or mobile" required>
                    </div>
                    ...
                    <div class="text-center">
                        <a href="{{ route('client.register') }}" class="text-decoration-none small">Don't have as account? Register</a>
                    </div>
                </form>
            </div>
        </div>
