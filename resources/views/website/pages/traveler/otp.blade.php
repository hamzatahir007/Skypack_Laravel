    ...
    <div class="row h-100">
        ...
        <div class="col-md-6 d-flex align-items-center justify-content-center">
            <div class="card p-4 w-100" style="max-width: 420px; border-radius: 12px; box-shadow: 0 8px 24px rgba(0,0,0,0.12);">
                ...
                {{-- OTP Form --}}
                <form action="{{ route('traveler.otp.verify') }}" method="POST" id="otpForm">
                    @csrf
                ...
                {{-- Resend --}}
                <form action="{{ route('traveler.otp.resend') }}" method="POST" class="mt-3 text-center">
                    @csrf
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('traveler.login') }}" class="text-decoration-none small text-muted">
                        ← Back to Login
                    </a>
                </div>
