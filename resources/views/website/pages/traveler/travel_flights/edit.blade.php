            ...
            <form action="{{ route('traveler.flights.update', $travel_flight->id) }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="flight_date" value="{{ optional($travel_flight->flight_date)->format('Y-m-d') }}"
                            class="form-control">
                    </div>
                        ...
                        <div id="restrictions-wrapper">
                            ...
                            @forelse(old('restrictions', $travel_flight->restrictions ?? []) as $index => $restriction)
                                <div class="input-group mb-2">
                                    ...
                                    @else
                                        <button type="button" class="btn btn-outline-danger remove-restriction">×</button>
                                    @endif
                                </div>
                            @empty
