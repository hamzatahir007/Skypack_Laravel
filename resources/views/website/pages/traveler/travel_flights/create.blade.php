...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('traveler.flights') }}" class="btn btn-secondary btn-radius">Back to Flight List</a>
    </div>
    ...
    <div class="card shadow mb-4 text-muted traveler-dashboard-page">
            ...
            <form action="{{ route('traveler.flights.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="restrictions[]" class="form-control mb-2" placeholder="No liquids">

                        <input type="text" name="restrictions[]" class="form-control mb-2" placeholder="No electronics">

                        <input type="text" name="restrictions[]" class="form-control" placeholder="Other (optional)">
                    </div> --}}
